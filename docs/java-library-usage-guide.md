...
soap.client-truststore-file | | ${JAVA_HOME}/jre/lib/security/cacerts | truststore path
soap.client-truststore-password | |changeit | truststore password
soap.client-truststore-type | | JKS | type of the truststore
