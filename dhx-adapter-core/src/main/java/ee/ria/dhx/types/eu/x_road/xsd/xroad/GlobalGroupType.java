...
/**
 * <p>
 * Java class for GlobalGroupType complex type.
 * 
 * <p>
 ...
 *         &lt;element name="groupMember" type="{http://x-road.eu/xsd/identifiers}XRoadClientIdentifierType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "GlobalGroupType", propOrder = {
    "groupCode",
    "description",
    "groupMember"
})
public class GlobalGroupType {

  @XmlElement(required = true)
  protected String groupCode;
  @XmlElement(required = true)
  protected String description;
  protected List<XRoadClientIdentifierType> groupMember;
   ...
   * there is not a <CODE>set</CODE> method for the groupMember property.
   * 
   * <p>
  ...
  public List<XRoadClientIdentifierType> getGroupMember() {
    if (groupMember == null) {
      groupMember = new ArrayList<XRoadClientIdentifierType>();
    }
