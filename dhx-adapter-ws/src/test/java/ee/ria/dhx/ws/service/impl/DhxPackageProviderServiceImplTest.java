...
public class DhxPackageProviderServiceImplTest {
  ...
  private InternalXroadMember getMember (){
    InternalXroadMember member = new InternalXroadMember("ee", "gov", "code", "DHX", "Name", null);
    return member;
  }
 ...
 public void getOutgoingPackageFileStringInternalXroadMember () throws Exception{
   ...
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(new FileInputStream(file), "consignment", recipient);
   ...
   verify(dhxMarshallerService, times(1)).validate(any(InputStream.class), any(InputStream.class));
   assertEquals("1.0", pckg.getDhxProtocolVersion());
 }  
 
 @Test
 public void getOutgoingPackageFileStringInternalXroadMemberInternalXroadMember () throws Exception{
   File file = new ClassPathResource("kapsel_21.xml").getFile();
   InternalXroadMember recipient = getMember();
   InternalXroadMember sender = getMember();
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(file, "consignment", recipient, sender);
   assertEquals(recipient, pckg.getService());
   assertEquals(sender, pckg.getClient());
   assertEquals("consignment", pckg.getInternalConsignmentId());
   assertNotNull(pckg.getDocumentFile());
 ...
 public void getOutgoingPackageFileStringStringString () throws Exception{
   ...
   when(soapConfig.getDefaultClient()).thenReturn(sender);
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(file, "consignment", "recCode", "recSystem");
   assertEquals(recipient, pckg.getService());
   assertEquals(sender, pckg.getClient());
 ...
 @Test
 public void getOutgoingPackageInputStreamStringInternalXroadMemberInternalXroadMember () throws Exception{
   File file = new ClassPathResource("kapsel_21.xml").getFile();
   InternalXroadMember recipient = getMember();
   InternalXroadMember sender = getMember();
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(new FileInputStream(file), "consignment", recipient, sender);
   assertEquals(recipient, pckg.getService());
   assertEquals(sender, pckg.getClient());
   assertEquals("consignment", pckg.getInternalConsignmentId());
   assertNotNull(pckg.getDocumentFile());
 ...
 @Test
 public void getOutgoingPackageInputStreamStringInternalXroadMemberInternalXroadMemberNovalidation () throws Exception{
   File file = new ClassPathResource("kapsel_21.xml").getFile();
   InternalXroadMember recipient = getMember();
   InternalXroadMember sender = getMember();
   ...
   assertEquals("consignment", pckg.getInternalConsignmentId());
   assertNotNull(pckg.getDocumentFile());
   verify(dhxMarshallerService, times(0)).validate(any(InputStream.class), any(InputStream.class));
   assertEquals("1.0", pckg.getDhxProtocolVersion());
 } 
 ...
 public void getOutgoingPackageInputStreamStringStringString () throws Exception{
   ...
   when(addressService.getClientForMemberCode("recCode", "recSystem")).thenReturn(recipient);
   when(soapConfig.getDefaultClient()).thenReturn(sender);
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(new FileInputStream(file), "consignment", "recCode", "recSystem");
   assertEquals(recipient, pckg.getService());
   assertEquals(sender, pckg.getClient());
   assertEquals("recCode", pckg.getService().getMemberCode());
   assertEquals("recSystem", pckg.getService().getSubsystemCode());
 ...
 public void getOutgoingPackageFileStringStringStringString () throws Exception{
   ...
   when(addressService.getClientForMemberCode("recCode", "recSystem")).thenReturn(recipient);
   when(soapConfig.getDefaultClient()).thenReturn(sender);
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(file, "consignment", "recCode", "recSystem", "senderSystem");
   assertEquals(recipient, pckg.getService());
   assertEquals(sender, pckg.getClient());
   assertEquals("recCode", pckg.getService().getMemberCode());
   assertEquals("recSystem", pckg.getService().getSubsystemCode());
 ...
 public void getOutgoingPackageInputStreamStringStringStringString () throws Exception{
   ...
   when(addressService.getClientForMemberCode("recCode", "recSystem")).thenReturn(recipient);
   when(soapConfig.getDefaultClient()).thenReturn(sender);
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(new FileInputStream(file), "consignment", "recCode", "recSystem", "senderSystem");
   assertEquals(recipient, pckg.getService());
   assertEquals(sender, pckg.getClient());
   assertEquals("recCode", pckg.getService().getMemberCode());
   assertEquals("recSystem", pckg.getService().getSubsystemCode());
 ...
 @Test
 public void getOutgoingPackageFileStringInternalXroadMemberInternalXroadMemberInputStreamString () throws Exception{
   File file = new ClassPathResource("kapsel_21.xml").getFile();
   InternalXroadMember recipient = getMember();
   InternalXroadMember sender = getMember();
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(file, "consignment", recipient, sender, new InputStream() { 
    @Override
 ...
 public void getOutgoingPackageFileStringStringStringStringString () throws Exception{
   ...
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(file, "consignment", "recCode", "recSystem", "senderCode", "senderSystem");
   assertEquals(recipient, pckg.getService());
   assertEquals(sender, pckg.getClient());
   assertEquals("consignment", pckg.getInternalConsignmentId());
   assertNotNull(pckg.getDocumentFile());
 ...
 @Test
 public void getOutgoingPackageInputStreamStringInternalXroadMemberInternalXroadMemberInputStreamString () throws Exception{
   File file = new ClassPathResource("kapsel_21.xml").getFile();
   InternalXroadMember recipient = getMember();
   InternalXroadMember sender = getMember();
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(new FileInputStream(file), "consignment", recipient, sender, new InputStream() { 
    @Override
    public int read() throws IOException {
      return 0;
    }
 ...
 public void getOutgoingPackageInputStreamStringStringStringStringString () throws Exception{
   ...
   when(addressService.getClientForMemberCode("recCode", "recSystem")).thenReturn(recipient);
   when(addressService.getClientForMemberCode("senderCode", "senderSystem")).thenReturn(sender);
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(new FileInputStream(file), "consignment", "recCode", "recSystem", "senderCode", "senderSystem");
   assertEquals(recipient, pckg.getService());
   assertEquals(sender, pckg.getClient());
   assertEquals("consignment", pckg.getInternalConsignmentId());
   assertNotNull(pckg.getDocumentFile());
 ...
 @Test
 public void getOutgoingPackageInputStreamStringStringStringStringStringInputStreamString () throws Exception{
   File file = new ClassPathResource("kapsel_21.xml").getFile();
   InternalXroadMember recipient = getMember();
   InternalXroadMember sender = getMember();
   recipient.setMemberCode("recCode");
   ...
   when(addressService.getClientForMemberCode("recCode", "recSystem")).thenReturn(recipient);
   when(addressService.getClientForMemberCode("senderCode", "senderSystem")).thenReturn(sender);
   OutgoingDhxPackage pckg = dhxPackageProviderService.getOutgoingPackage(new FileInputStream(file), "consignment", "recCode", "recSystem", "senderCode", "senderSystem", new InputStream() { 
     @Override
     public int read() throws IOException {
       return 0;
     }
 ...
 public void getOutgoingPackageFileString () throws Exception{
   ...
   when(dhxMarshallerService.unmarshallAndValidate(any(File.class), any(InputStream.class))).thenReturn(new DecContainer());
   List<OutgoingDhxPackage> pckgs = dhxPackageProviderService.getOutgoingPackage(file, "consignment");
   ...
   verify(dhxMarshallerService, times(1)).unmarshallAndValidate(any(File.class), any(InputStream.class));
 ...
 public void getOutgoingPackageInpuStreamString () throws Exception{
   ...
   adressees.add(adressee);
   when(capsuleConfig.getAdresseesFromContainer(any())).thenReturn(adressees);
   when(dhxMarshallerService.unmarshallAndValidate(any(InputStream.class), any(InputStream.class))).thenReturn(new DecContainer());
   List<OutgoingDhxPackage> pckgs = dhxPackageProviderService.getOutgoingPackage(new FileInputStream(file), "consignment");
   assertEquals(1, pckgs.size());
   assertEquals(recipient, pckgs.get(0).getService());
   assertEquals(sender, pckgs.get(0).getClient());
   assertEquals("consignment", pckgs.get(0).getInternalConsignmentId());
   assertNotNull(pckgs.get(0).getDocumentFile());
   verify(dhxMarshallerService, times(1)).unmarshallAndValidate(any(InputStream.class), any(InputStream.class));
   assertEquals("1.0", pckgs.get(0).getDhxProtocolVersion());
   assertEquals(CapsuleVersionEnum.V21, pckgs.get(0).getParsedContainerVersion());
 }  
 ...
 public void getOutgoingPackageInpuStreamStringCapsuleVersionEnum () throws Exception{
   ...
   when(capsuleConfig.getAdresseesFromContainer(any())).thenReturn(adressees);
   when(dhxMarshallerService.unmarshallAndValidate(any(InputStream.class), any(InputStream.class))).thenReturn(new DecContainer());
   List<OutgoingDhxPackage> pckgs = dhxPackageProviderService.getOutgoingPackage(new FileInputStream(file), "consignment", CapsuleVersionEnum.V21);
   assertEquals(1, pckgs.size());
   assertEquals(recipient, pckgs.get(0).getService());
   assertEquals(sender, pckgs.get(0).getClient());
   assertEquals("consignment", pckgs.get(0).getInternalConsignmentId());
 ...
 public void getOutgoingPackageFileStringCapsuleVersionEnum () throws Exception{
   ...
   when(capsuleConfig.getAdresseesFromContainer(any())).thenReturn(adressees);
   when(dhxMarshallerService.unmarshallAndValidate(any(File.class), any(InputStream.class))).thenReturn(new DecContainer());
   List<OutgoingDhxPackage> pckgs = dhxPackageProviderService.getOutgoingPackage(file, "consignment", CapsuleVersionEnum.V21);
   assertEquals(1, pckgs.size());
   assertEquals(recipient, pckgs.get(0).getService());
   assertEquals(sender, pckgs.get(0).getClient());
   assertEquals("consignment", pckgs.get(0).getInternalConsignmentId());
