...
public class DhxPackageServceImplTest {
  ...
  public void init() throws DhxException{
    ...
    when(dhxImplementationSpecificService.isDuplicatePackage(any(InternalXroadMember.class), anyString())).thenReturn(false);
...
// representee, check recipeint representee
  ...
  public void receiveDocumentFromEndpoint () throws DhxException, IOException{
    ...
    when(dhxConfig.getParseCapsule()).thenReturn(true);
    when(dhxImplementationSpecificService.receiveDocument(any(IncomingDhxPackage.class), any(MessageContext.class))).thenReturn("id1");
    ...
    verify(dhxImplementationSpecificService, times(1)).receiveDocument(any(IncomingDhxPackage.class), any(MessageContext.class));
    verify(dhxImplementationSpecificService, times(1)).isDuplicatePackage(any(InternalXroadMember.class), anyString());
  }
  ...
  @Test
  public void receiveDocumentFromEndpointToRepresenteeSubsystem () throws DhxException, IOException{
    SendDocument request = new SendDocument();
    request.setConsignmentId("consignmentId");
    File file = new ClassPathResource("kapsel_21.xml").getFile();
    request.setDocumentAttachment(FileUtil.getDatahandlerFromFile(file));
  ...
  @Test
  public void receiveDocumentFromEndpointToRepresenteeWrongCapsuleAdressee() throws DhxException, IOException{
    SendDocument request = new SendDocument();
    request.setConsignmentId("consignmentId");
    File file = new ClassPathResource("kapsel_21.xml").getFile();
    request.setDocumentAttachment(FileUtil.getDatahandlerFromFile(file));
  ...
  @Test
  public void receiveDocumentFromEndpointToWrongRepresenteeSubsystem() throws DhxException, IOException{
    SendDocument request = new SendDocument();
    request.setConsignmentId("consignmentId");
    File file = new ClassPathResource("kapsel_21.xml").getFile();
    request.setDocumentAttachment(FileUtil.getDatahandlerFromFile(file));
  ...
  public void receiveDocumentFromEndpointNonDefaultSubsystem () throws DhxException, IOException{
    ...
    request.setDHXVersion("1.0");
    InternalXroadMember client = new InternalXroadMember("ee", "GOV", "400", "DHX", "Name", null);
    InternalXroadMember service = new InternalXroadMember("ee", "GOV", "401", "DHX.subsystem", "Name", null);
    DhxOrganisationFactory.setDhxSubsystemPrefix("DHX");
    List<String> subsystems = new ArrayList<String>();
  ...
  public void receiveDocumentFromEndpointNoParsing () throws DhxException, IOException{
    ...
    verify(dhxMarshallerService, times(0)).unmarshallAndValidate(any(InputStream.class), any(InputStream.class));
    verify(dhxImplementationSpecificService, times(1)).receiveDocument(any(IncomingDhxPackage.class), any(MessageContext.class));
  }
  ...
  public void receiveDocumentFromEndpointNovalidation () throws DhxException, IOException{
    ...
    when(dhxMarshallerService.unmarshallAndValidate(any(InputStream.class), any(InputStream.class))).thenReturn(new DecContainer());
    dhxPackageService.receiveDocumentFromEndpoint(request, client, service, null);
    verify(dhxMarshallerService, times(1)).unmarshallAndValidate(any(InputStream.class), Mockito.isNull(InputStream.class));
    verify(dhxImplementationSpecificService, times(1)).receiveDocument(any(IncomingDhxPackage.class), any(MessageContext.class));
    verify(dhxImplementationSpecificService, times(1)).isDuplicatePackage(any(InternalXroadMember.class), anyString());
  }
  ...
  public void receiveDocumentFromEndpointNoValidationNoParsing () throws DhxException, IOException{
    ...
    dhxPackageService.receiveDocumentFromEndpoint(request, client, service, null);
    verify(dhxMarshallerService, times(0)).unmarshallAndValidate(any(InputStream.class), any(InputStream.class));
    verify(dhxMarshallerService, times(0)).validate(any(InputStream.class), Mockito.isNull(InputStream.class));
    verify(dhxImplementationSpecificService, times(1)).receiveDocument(any(IncomingDhxPackage.class), any(MessageContext.class));
    verify(dhxImplementationSpecificService, times(1)).isDuplicatePackage(any(InternalXroadMember.class), anyString());
  }
  ...
  public void receiveDocumentFromEndpointDuplicate () throws DhxException, IOException{
    ...
    when(dhxImplementationSpecificService.receiveDocument(any(IncomingDhxPackage.class), any(MessageContext.class))).thenReturn("id1");
    when(dhxMarshallerService.unmarshallAndValidate(any(InputStream.class), any(InputStream.class))).thenReturn(new DecContainer());
    when(dhxImplementationSpecificService.isDuplicatePackage(any(InternalXroadMember.class), anyString())).thenReturn(true);
    expectedEx.expect(DhxException.class);
  ...
  public void receiveDocumentFromEndpointRepresenteeSender () throws DhxException, IOException{
    ...
    InternalXroadMember client = new InternalXroadMember("ee", "GOV", "420", "DHX", "Name", representee);
    InternalXroadMember service = new InternalXroadMember("ee", "GOV", "401", "DHX", "Name", null);
    when(dhxConfig.getParseCapsule()).thenReturn(true);
    when(dhxImplementationSpecificService.receiveDocument(any(IncomingDhxPackage.class), any(MessageContext.class))).thenReturn("id1");
    when(dhxMarshallerService.unmarshallAndValidate(any(InputStream.class), any(InputStream.class))).thenReturn(new DecContainer());
