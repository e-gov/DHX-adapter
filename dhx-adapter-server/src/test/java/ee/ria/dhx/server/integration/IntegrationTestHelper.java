...
public class IntegrationTestHelper {
	...
	public static Source getEnvelope(XRoadClientIdentifierType client, XRoadServiceIdentifierType service,
			XRoadRepresentedPartyType representee, Object body) throws DhxException {
		try {
			/*
			 * DhxMarshallerService dhxMarshallerService =
			 * AppContext.getApplicationContext()
			 * .getBean(DhxMarshallerService.class);
			 */
			...
			String envelopePre = "<soapenv:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" "
			...
			ee.ria.dhx.types.eu.x_road.xsd.xroad.ObjectFactory factory = new ee.ria.dhx.types.eu.x_road.xsd.xroad.ObjectFactory();
			ee.ria.dhx.types.eu.x_road.xsd.representation.ObjectFactory reprFactory = new ObjectFactory();
	...
	public static DataHandler createDatahandlerFromList(List<? extends Object> objList) throws DhxException {
		DhxMarshallerService dhxMarshallerService = AppContext.getApplicationContext()
				.getBean(DhxMarshallerService.class);
		...
		try {
			...
			for (Object obj : objList) {
				dhxMarshallerService.marshallToOutputStream(obj, zippedStream);
			}
			zippedStream.finish();
			base64Stream.flush();
			fos.flush();
