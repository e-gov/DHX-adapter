...
package ee.riik.schemas.dhl_meta_manual;
...
public class ObjectFactory {
    ...
    private final static QName _KoostajaAsutuseNr_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_asutuse_nr");
    private final static QName _SaajaAsutuseNr_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "saaja_asutuse_nr");
    private final static QName _KoostajaDokumendinimi_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_dokumendinimi");
    private final static QName _KoostajaDokumendityyp_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_dokumendityyp");
    private final static QName _KoostajaVotmesona_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_votmesona");
    private final static QName _KoostajaDokumendinr_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_dokumendinr");
    private final static QName _KoostajaKuupaev_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_kuupaev");
    private final static QName _KoostajaAsutuseNimi_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_asutuse_nimi");
    private final static QName _KoostajaAsutuseKontakt_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_asutuse_kontakt");
    private final static QName _AutoriOsakond_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "autori_osakond");
    private final static QName _AutoriIsikukood_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "autori_isikukood");
    private final static QName _AutoriNimi_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "autori_nimi");
    private final static QName _AutoriKontakt_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "autori_kontakt");
    private final static QName _SeotudDhlId_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "seotud_dhl_id");
    private final static QName _SeotudDokumendinrKoostajal_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "seotud_dokumendinr_koostajal");
    private final static QName _SeotudDokumendinrSaajal_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "seotud_dokumendinr_saajal");
    private final static QName _SaatjaDokumendinr_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "saatja_dokumendinr");
    private final static QName _SaatjaKuupaev_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "saatja_kuupaev");
    private final static QName _SaatjaAsutuseKontakt_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "saatja_asutuse_kontakt");
    private final static QName _SaajaIsikukood_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "saaja_isikukood");
    private final static QName _SaajaNimi_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "saaja_nimi");
    private final static QName _SaajaOsakond_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "saaja_osakond");
    private final static QName _KoostajaFailinimi_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_failinimi");
    private final static QName _KoostajaKataloog_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_kataloog");
    private final static QName _KoostajaKokkuvote_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "koostaja_kokkuvote");
    private final static QName _SisuId_QNAME = new QName("http://www.riik.ee/schemas/dhl-meta-manual", "sisu_id");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ee.riik.schemas.dhl_meta_manual
     * 
     */
