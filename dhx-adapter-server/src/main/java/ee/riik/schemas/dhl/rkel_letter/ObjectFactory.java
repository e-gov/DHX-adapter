...
public class ObjectFactory {
    ...
    private final static QName _LetterExport_QNAME = new QName("http://www.riik.ee/schemas/dhl/rkel_letter", "LetterExport");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ee.riik.schemas.dhl.rkel_letter
     * 
     */
