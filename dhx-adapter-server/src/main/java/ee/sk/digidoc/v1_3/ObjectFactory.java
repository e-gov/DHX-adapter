...
public class ObjectFactory {
    ...
    private final static QName _SignedDoc_QNAME = new QName("http://www.sk.ee/DigiDoc/v1.3.0#", "SignedDoc");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ee.sk.digidoc.v1_3
     * 
     */
